...
java -Xmx180m -Xms90m -XX:+UseSerialGC -XX:MaxRAM=256m -XX:CompressedClassSpaceSize=64m -XX:ReservedCodeCacheSize=64m -Xss256k -Dserver.port=8081 -jar /app/backend.jar &
